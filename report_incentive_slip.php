...
$mysqli = new mysqli("p:"."localhost", "effism_live", "4G&L6b^GFQNB!U-WT)", "effism_live");
//$mysqli = new mysqli("p:"."localhost", "efftime_dummy", "4G&L6b^GFQNB!U-WT)", "efftime_dummy");
//$mysqli = new mysqli('localhost', 'root', '', 'effism');
define('VALIDITY_SECONDS', 600); //600 for 10 mins
define('QR_HMAC_SECRET', 'AriesHRMS@2024#xK9$mP2&qL7!nR4@zWq8^vYt1');
